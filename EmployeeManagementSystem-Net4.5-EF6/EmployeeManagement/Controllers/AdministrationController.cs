        ...
        public async Task<IActionResult> DeleteUser(string id)
        {
            ...
            else
            {
                ...
                catch (DbUpdateException ex)
                {
                    ...
                    ViewBag.ErrorMessage = $"{user.UserName} user cannot be deleted as there are assigned roles/claims " +
                        $"to this user. If you want to delete this user, please remove the assigned roles/claims from " +
                        $"the user and then try to delete";
